...
class MyArrayList{
    ...
    public boolean remove2(int location){
        if(!isEmpty() && isLocationValid(location)){
            items[location-1] = items[count-1];
            items[count-1] = null;
            count = count - 1;
            return true;
        }
            ...
            case 6:
                ...
                do{
                    try{
                        ...
                        }else if(array.edit(toEdit, toReplace) == 0) {
            ...
            case 8:
                ...
                do{
                    try{
                        ...
                        int loc = in.nextInt();
                        in.nextLine();
                        System.out.printf("the element on that location is %s. ",array.get(loc-1));
                    }catch(Exception e){
                        checker4 = true;
                        System.out.println("You can only input integers.");
                        in.next();
